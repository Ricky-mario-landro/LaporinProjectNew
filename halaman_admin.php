...
?>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="style='text-align: center;'"><?= $data['nama']; ?></td>
                    ...
                    <form method="post" action="function/setujui_laporan_action.php">
                        ...
                        <button name="disetujui">Setujui</button> <!--ini tombolnya-->
                    </form>
                    </td>
                    <!-- END tombol setujui -->
                    ...
                    <td>
                      <form method="post" action="function/tolak_laporan_action.php">
                        <input type="hidden" name="baris_sekarang" value="<?= $data['no_telepon']; ?>" />
                        <button name="ditolak">Tolak</button> <!--ini tombolnya-->
                    </form>
                    </td>
                    <!-- END tombol tolak -->
 ...
 ?>
  ...
  <!-- wave animation -->
  <svg width="100%" height="100%" id="svg" viewBox="0 0 750 400" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150"><style>
    .path-0{
      animation:pathAnim-0 4s;
      animation-timing-function: linear;
      animation-iteration-count: infinite;
