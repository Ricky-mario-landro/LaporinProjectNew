...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top backgrounD">
      <div class="container">
      <a class="navbar-brand animate__animated animate__heartBeat" href="">LAPORIN</a>
      ...
      <div class="collapse navbar-collapse mr-2 animate__animated animate__fadeInDownBig" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item text-center">
            <a class="nav-link d-sm-block" href="#">Home <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item text-center">
            <a class="nav-link" href="#tata-Cara">Tata Cara</a>
          </li>
          <li class="nav-item text-center">
            <a class="nav-link" href="#historiLaporan">Histori</a>
          </li>
          <li class="nav-item text-center">
            <a class="nav-link active" href="login_admin.html">Login</a>
          </li>
        </ul>
      </div>
      </div>
    ...
    <section class="hero mt-5 pt-5">
      <div class="container">
        ...
        <div class="col-12 col-lg-7 align-self-center animate__animated animate__backInLeft">
          <div class="d-lg-none d-md-none d-sm-block tengah mb-3 animate__animated animate__backInDown">
            <img src="Images/anno3.png" width="350" alt="" style="display: block; margin: auto !important;">
          </div>
            <h1 class="heroFont tengah">LAPORIN.</h1>

            <p class="hero-desc mt-4 tengah" style="letter-spacing: 1.5px;"> 
            Merupakan aplikasi pelayanan  </br>
            publik untuk masyarakat melaporkan  </br> 
            kejadian disekitar berbasis website yang  <br>
            bisa diakses dimana saja dan kapan saja.</p>
          

          <div class="mt-5 tengah mb-4">
            <a class="button-primary btn-lg" href="form-pengaduan.html" role="button">Lapor!</a>
          </div>
          
        </div>
          <div class="col-5 d-none d-sm-none image d-lg-block animate__animated animate__flipInY">
            <img src="Images/anno2.png"  alt="announcement">
          </div>
        </div>
      </div>

      <!-- Wave Animation -->
      <svg width="100%" height="100%" id="svg" viewBox="0 0 1440 300" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150"><style>
        .path-0{
        ...
        @keyframes pathAnim-0{
          0%{
            d: path("M 0,500 C 0,500 0,250 0,250 C 75.9230504981106,248.45207832360012 151.8461009962212,246.90415664720024 225,265 C 298.1538990037788,283.09584335279976 368.5386465132258,320.8354517347991 440,316 C 511.4613534867742,311.1645482652009 583.9993129508758,263.75403641360356 650,235 C 716.0006870491242,206.24596358639644 775.4641016832704,196.14840261078672 832,185 C 888.5358983167296,173.85159738921328 942.1442803160428,161.6523531432497 1011,174 C 1079.8557196839572,186.3476468567503 1163.958777052559,223.24218481621438 1238,240 C 1312.041222947441,256.7578151837856 1376.0206114737205,253.3789075918928 1440,250 C 1440,250 1440,500 1440,500 Z");
          }
          25%{
            d: path("M 0,500 C 0,500 0,250 0,250 C 62.3785640673308,229.12469941600824 124.7571281346616,208.2493988320165 186,185 C 247.2428718653384,161.7506011679835 307.35005152868433,136.12710408794229 382,179 C 456.64994847131567,221.87289591205771 545.8426657506011,333.2421848162144 612,338 C 678.1573342493989,342.7578151837856 721.2792854689111,240.90415664720027 784,225 C 846.7207145310889,209.09584335279973 929.0401923737547,279.1411885949846 1003,299 C 1076.9598076262453,318.8588114050154 1142.55994503607,288.53108897286154 1214,272 C 1285.44005496393,255.4689110271385 1362.720027481965,252.73445551356923 1440,250 C 1440,250 1440,500 1440,500 Z");
          }
          50%{
            d: path("M 0,500 C 0,500 0,250 0,250 C 57.7931982136723,250.46856750257643 115.5863964273446,250.93713500515287 183,276 C 250.4136035726554,301.06286499484713 327.44761250429394,350.72002748196496 410,340 C 492.55238749570606,329.27997251803504 580.6231535554792,258.1827550669873 648,221 C 715.3768464445208,183.81724493301272 762.0597732737892,180.54895225008588 819,180 C 875.9402267262108,179.45104774991412 943.1377533493644,181.62143593266921 1018,215 C 1092.8622466506356,248.37856406733079 1175.389213328753,312.96530401923735 1247,324 C 1318.610786671247,335.03469598076265 1379.3053933356236,292.5173479903813 1440,250 C 1440,250 1440,500 1440,500 Z");
          }
          75%{
            d: path("M 0,500 C 0,500 0,250 0,250 C 82.07557540364135,234.62864994847132 164.1511508072827,219.25729989694264 229,203 C 293.8488491927173,186.74270010305736 341.47097217451045,169.59945036070079 397,177 C 452.52902782548955,184.40054963929921 515.9649604946754,216.34489866025422 601,249 C 686.0350395053246,281.6551013397458 792.6691858467881,315.0209549982824 858,309 C 923.3308141532119,302.9790450017176 947.3582961181723,257.5712813466163 998,224 C 1048.6417038818277,190.42871865338373 1125.897629680522,168.69391961525247 1204,175 C 1282.102370319478,181.30608038474753 1361.051185159739,215.65304019237377 1440,250 C 1440,250 1440,500 1440,500 Z");
          }
          100%{
            d: path("M 0,500 C 0,500 0,250 0,250 C 75.9230504981106,248.45207832360012 151.8461009962212,246.90415664720024 225,265 C 298.1538990037788,283.09584335279976 368.5386465132258,320.8354517347991 440,316 C 511.4613534867742,311.1645482652009 583.9993129508758,263.75403641360356 650,235 C 716.0006870491242,206.24596358639644 775.4641016832704,196.14840261078672 832,185 C 888.5358983167296,173.85159738921328 942.1442803160428,161.6523531432497 1011,174 C 1079.8557196839572,186.3476468567503 1163.958777052559,223.24218481621438 1238,240 C 1312.041222947441,256.7578151837856 1376.0206114737205,253.3789075918928 1440,250 C 1440,250 1440,500 1440,500 Z");
          }
        }</style><path d="M 0,500 C 0,500 0,250 0,250 C 75.9230504981106,248.45207832360012 151.8461009962212,246.90415664720024 225,265 C 298.1538990037788,283.09584335279976 368.5386465132258,320.8354517347991 440,316 C 511.4613534867742,311.1645482652009 583.9993129508758,263.75403641360356 650,235 C 716.0006870491242,206.24596358639644 775.4641016832704,196.14840261078672 832,185 C 888.5358983167296,173.85159738921328 942.1442803160428,161.6523531432497 1011,174 C 1079.8557196839572,186.3476468567503 1163.958777052559,223.24218481621438 1238,240 C 1312.041222947441,256.7578151837856 1376.0206114737205,253.3789075918928 1440,250 C 1440,250 1440,500 1440,500 Z" stroke="none" stroke-width="0" fill="#ffffffff" class="transition-all duration-300 ease-in-out delay-150 path-0"></path></svg>
      <!-- End Wave Animation -->
    </section>
    <!-- End Header Hero -->
    ...
    <section class="mt-5 mb-5">
      <div class="container tata-Cara">
        <div class="row mb-3">
          <div class="col text-center wow fadeInLeft">
              <h1 id="tata-Cara" style="font-family: 'Podkova'; color: #16213E; margin-top: -80px; font-size: 56px;" class="send"> Tata <span style="font-weight: bold;"> Cara Melapor </span> </h1>
          </div>
        
          <div class="col-12 col-lg-12 align-self-center wow fadeInRight" style="margin-bottom: -60px;">
            <div class="row text-center">

              <div class="col-6 col-lg align-self-center jarak mr-3 mt-3 ">      
                <img src="Images/writing.png" width="100" alt="tulis"/>
                <h4>1. Tulis Laporan Anda</h4>
              </div>

              <div class="col-6 col-lg align-self-center jarak mr-3 mt-3">
                <img src="Images/processing.png" width="100" alt="verifikasi"/>
                <h4>2. Proses Verifikasi Laporan</h4>
              </div>

              <div class="col-6 col-lg align-self-center jarak mr-3 mt-3">
                <img src="Images/customer-service.png" width="100" alt="tindak lanjut" />
                <h4>3. Tindak Lanjut Laporan</h4>
              </div>

              <div class="col-6 col-lg align-self-center jarak mr-3 mt-3">
                <img src="Images/encrypted.png" width="100" alt="selesai">
                <h4>4. Laporan Telah Selesai</h4>
              </div>
            </div>
          </div>
    </section>
  ...
  <!-- wave animation -->
  <svg width="100%" height="100%" id="svg" viewBox="0 0 900 400" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150"><style>
    .path-0{
      animation:pathAnim-0 4s;
      animation-timing-function: linear;
      animation-iteration-count: infinite;
...
$sql = "SELECT nama, no_telepon, tanggal, jenis_laporan, lokasi, deskripsi FROM laporan WHERE info = 1 ORDER BY tanggal DESC";
